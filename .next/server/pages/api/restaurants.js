"use strict";(()=>{var a={};a.id=445,a.ids=[445],a.modules={781:(a,e,t)=>{t.a(a,async(a,r)=>{try{t.r(e),t.d(e,{createRestaurant:()=>u,getAllRestaurants:()=>E,getOnboardingData:()=>i,getRestaurantStats:()=>l,initializeDatabase:()=>o,saveOnboardingData:()=>d});var n=t(3397),s=a([n]);async function o(){try{return await (0,n.sql)`
    ...
    `).rows[0]}catch(a){throw console.error("Error creating restaurant:",a),a}}async function l(a){try{return(await (0,n.sql)`
      ...
      WHERE restaurant_id = ${a}
    `).rows[0]}catch(a){return console.error("Error getting restaurant stats:",a),{total_members:0,active_members:0,completed_members:0,pending_members:0}}}n=(s.then?(await s)():s)[0],r()}catch(a){r(a)}})},3397:a=>{a.exports=import("@vercel/postgres")},3465:(a,e,t)=>{t.a(a,async(a,r)=>{try{t.r(e),t.d(e,{default:()=>o});var n=t(781),s=a([n]);async function o(a,e){if(e.setHeader("Access-Control-Allow-Origin","*"),e.setHeader("Access-Control-Allow-Methods","GET, POST, OPTIONS"),e.setHeader("Access-Control-Allow-Headers","Content-Type"),"OPTIONS"===a.method)return void e.status(200).end();try{if(await (0,n.initializeDatabase)(),"GET"===a.method){let a=await (0,n.getAllRestaurants)();e.status(200).json(a)}else if("POST"===a.method){let t=a.body;if(!t.name||!t.store_number)return e.status(400).json({error:"Restaurant name and store number are required"});let r=await (0,n.createRestaurant)(t);e.status(201).json(r)}else e.status(405).json({error:"Method not allowed"})}catch(a){console.error("Restaurants API error:",a),e.status(500).json({error:"Internal server error"})}}n=(s.then?(await s)():s)[0],r()}catch(a){r(a)}})},3480:(a,e,t)=>{a.exports=t(5600)},5600:a=>{a.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6435:(a,e)=>{Object.defineProperty(e,"M",{enumerable:!0,get:function(){return function a(e,t){return t in e?e[t]:"then"in e&&"function"==typeof e.then?e.then(e=>a(e,t)):"function"==typeof e&&"default"===t?e:void 0}}})},8667:(a,e)=>{Object.defineProperty(e,"A",{enumerable:!0,get:function(){return t}});var t=function(a){return a.PAGES="PAGES",a.PAGES_API="PAGES_API",a.APP_PAGE="APP_PAGE",a.APP_ROUTE="APP_ROUTE",a.IMAGE="IMAGE",a}({})},9226:(a,e,t)=>{t.a(a,async(a,r)=>{try{t.r(e),t.d(e,{config:()=>u,default:()=>E,routeModule:()=>l});var n=t(3480),s=t(8667),o=t(6435),i=t(3465),d=a([i]);i=(d.then?(await d)():d)[0];let E=(0,o.M)(i,"default"),u=(0,o.M)(i,"config"),l=new n.PagesAPIRouteModule({definition:{kind:s.A.PAGES_API,page:"/api/restaurants",pathname:"/api/restaurants",bundlePath:"",filename:""},userland:i});r()}catch(a){r(a)}})}};var e=require("../../webpack-api-runtime.js");e.C(a);var t=e(e.s=9226);module.exports=t})();